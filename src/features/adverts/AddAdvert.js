...
const AddAdvert = () => {
  ...
  const { newAdvertStatus, status, createdAdvert } = useSelector((state) => state.adverts);
  ...
  if (newAdvertStatus === "succeeded" && createdAdvert) {
    navigate(`/adverts/${createdAdvert.id}/requirements`);
  }

  // console.log("chech successd", status)
